...
namespace SmartRedirectSuggester.Composers
{
    public class SmartRedirectSuggesterApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                opt.OperationFilter<SmartRedirectSuggesterOperationSecurityFilter>();
            });
        }
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("SmartRedirectSuggester.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
